...
importScripts(location.origin + "/container2wasm-demo-deno" + "/src/browser_wasi_shim/index.js");
importScripts(location.origin + "/container2wasm-demo-deno" + "/src/browser_wasi_shim/wasi_defs.js");
importScripts(location.origin + "/container2wasm-demo-deno" + "/src/worker-util.js");
importScripts(location.origin + "/container2wasm-demo-deno" + "/src/wasi-util.js");
